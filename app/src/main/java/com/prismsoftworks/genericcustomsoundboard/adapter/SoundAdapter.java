...
public class SoundAdapter extends RecyclerView.Adapter<SoundAdapter.SoundView> {
    ...
    public void onBindViewHolder(SoundView holder, int position) {
        ...
        holder.soundName.setText(sound.getTitle());
        if (sound.getSoundFile() != null) {
            Log.d(TAG, sound.getSoundFile().getName());
            holder.soundPlay.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    class SoundView extends RecyclerView.ViewHolder {
        ...
        SoundView(View view) {
            super(view);
            soundPlay = view.findViewById(R.id.sound_play);
